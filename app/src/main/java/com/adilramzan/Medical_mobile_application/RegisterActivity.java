...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.etRegToLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.etRegisterBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(username.length()==0 || email.length()==0 || password.length()==0 || confirm.length()==0){
                    Toast.makeText(RegisterActivity.this, "Fill all data fields", Toast.LENGTH_SHORT).show();
                }else{
                    if(password.compareTo(confirm)==0) {
                        if(isValid(password)){
                            ...
                            Toast.makeText(RegisterActivity.this, "Password must have 8 characters,containing letter,digit,symbol and special character", Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        Toast.makeText(RegisterActivity.this, "Passwords aren't matched", Toast.LENGTH_SHORT).show();
                    }
                }
