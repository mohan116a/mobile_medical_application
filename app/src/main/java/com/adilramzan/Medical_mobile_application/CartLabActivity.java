...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton = findViewById(R.id.btnDatePickerCart);
        timeButton = findViewById(R.id.btnTimePickerCart);
       ...
       //Toast.makeText(getApplicationContext(),""+dbData, Toast.LENGTH_LONG).show();
        ...
        binding.tvCostCart.setText("Total Fee: "+totalPrice);
        ...
        binding.btnCheckOutCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                it.putExtra("price",binding.tvCostCart.getText());
